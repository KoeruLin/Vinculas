...
wave_current[1] = array_shuffle(array_concat(array_create(2, obj_knight), 
				  array_create(6, obj_tank)));

wave_current[2] = array_shuffle(array_concat(array_create(4, obj_knight), 
				  array_create(4, obj_archer)));

wave_current[3] = array_shuffle(array_concat(array_create(4, obj_knight), 
				  array_create(2, obj_tank), array_create(6, obj_archer)));

wave_current[4] = array_create(16, obj_archer);

wave_current[5] = array_create(4, obj_necromancer);

wave_current[6] = array_shuffle(array_concat(array_create(12, obj_tank), 
				  array_create(6, obj_archer)));

wave_current[7] = array_shuffle(array_concat(array_create(3, obj_knight), 
				  array_create(9, obj_tank), array_create(9, obj_archer)));

wave_current[8] = array_shuffle(array_concat(array_create(19, obj_knight), 
				  array_create(6, obj_tank), array_create(3, obj_archer)));
...
wave_current[14] = array_shuffle(array_create(16, obj_necromancer));
